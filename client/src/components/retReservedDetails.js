  ...
  const navigate=useNavigate();
   ...
   const[flightList, setFlightList]=useState([]);
     ...
     for (var j in flightList){
      ...
      localStorage["returnSeatsEdited"]=JSON.stringify(filteredFlightList);
  ...
  return (
    ...
    <div>
      ...
      <div className="Button"/>
        <h2>
        To reserve flight and proceed to seats selection, please click below:
          </h2>
        <Button variant="contained" onClick={()=>{navigate("retSeatsEdited")}}>Proceed</Button>
        <br/>
       </Container>
      </div>
  );
}
export default RetReservedDetails;

// retReservedDetails.push({
//   "flightNo":filteredFlightList[0].flightNo,
//   "flightID":ID2,
//   "date":filteredFlightList[0].date,
//   "departureTime":filteredFlightList[0].departureTime,
//   "arrivalTime":filteredFlightList[0].arrivalTime,
//   "departureAirport":filteredFlightList[0].departureAirport,
//   "arrivalAirport":filteredFlightList[0].arrivalAirport,
//   "departureTerminal":filteredFlightList[0].departureTerminal,
//   "arrivalTerminal":filteredFlightList[0].arrivalTerminal,
//   "tripDuration":difference,
//   "allowance":allowance,
//   "price":price,
//   "class":cabinClass
...
// localStorage["retReservedDetails"]=JSON.stringify(retReservedDetails);