...
var departureSeatsEdited=JSON.parse(localStorage['departureSeatsEdited']);
 let economicCount=0;
 let businessCount=0;
 let countList=[];
 ...
 const[flightList, setFlightList]=useState([]);
  ...
  const [reservation1,setReservation1]=useState({
    flightNo:departureSeatsEdited[0].flightNo,
    flightID:ID2,
    date:departureSeatsEdited[0].date,
    departureTime:departureSeatsEdited[0].departureTime,
    arrivalTime:departureSeatsEdited[0].arrivalTime,
    departureAirport:departureSeatsEdited[0].departureAirport,
    arrivalAirport:departureSeatsEdited[0].arrivalAirport,
    departureTerminal:departureSeatsEdited[0].departureTerminal,
    arrivalTerminal:departureSeatsEdited[0].arrivalTerminal,
    tripDuration:departureSeatsEdited[0].tripDuration,
