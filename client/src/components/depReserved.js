  ...
  return (
    ...
    <div>
      ...
      <h2 align="left">
        ...
        <Button variant="contained" onClick={()=>{navigate("depSeatsReserved")}}>Proceed</Button>
        <Button variant="contained" onClick={()=>{navigate("editDepReserved")}}>Proceed</Button>
        </Stack>
        <br/>
        <h2 align="center">
