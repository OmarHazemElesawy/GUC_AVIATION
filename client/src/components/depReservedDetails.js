  ...
  const navigate=useNavigate();
   ...
   const[flightList, setFlightList]=useState([]);
     ...
     for (var j in flightList){
      ...
      localStorage["departureSeatsEdited"]=JSON.stringify(filteredFlightList);
  ...
  return (
    ...
    <div>
         <AppBar className={classes.appBar} position="static" color="inherit">
          <Typography className= {classes.heading} variant= "h4" align="center" >Your Selected Departure Flight details</Typography>
        </AppBar>
      ...
      <div className="Button"/>
        ...
        <Button variant="contained" onClick={()=>{navigate("depSeatsEdited")}}>Proceed</Button>
        <br/>
       </Container>
      </div>
  );
}
export default DepReservedDetails;

// depReservedDetails.push({
//   "flightNo":flightList[index].flightNo,
//   "flightID":ID2,
//   "date":flightList[index].date,
//   "departureTime":flightList[index].departureTime,
//   "arrivalTime":flightList[index].arrivalTime,
//   "departureAirport":flightList[index].departureAirport,
//   "arrivalAirport":flightList[index].arrivalAirport,
//   "departureTerminal":flightList[index].departureTerminal,
//   "arrivalTerminal":flightList[index].arrivalTerminal,
//   "tripDuration":difference,
//   "allowance":allowance,
//   "price":price,
//   "class":cabinClass
...
// localStorage["depReservedDetails"]=JSON.stringify(depReservedDetails);